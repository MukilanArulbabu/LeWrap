      ...
      <div className="franchize_container">
        ...
        <div className="franchize_content_wrapper">
          <div className="franchize_content_viewport">
            <div className="franchize_content blue" id="content1">
              Franchise with me
            </div>
            <div className="franchize_content black" id="content2">
              Franchise with us
            </div>
            <div className="franchize_content orange" id="content3">
              Franchise with me content need to be added only after the users gives their content
            </div>
          </div>
        </div>
      </div>
